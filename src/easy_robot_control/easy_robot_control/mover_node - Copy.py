...
from custom_messages.srv import ReturnVect3, SendTargetBody, SendTargetSet, Vect3, TFService
...
class MoverNode(EliaNode):
    ...
    def __init__(self):
        ...
        self.create_service(TFService, "body_tfshift", self.body_tfshift_cbk)
        self.create_service(SendTargetBody, "go2_targetbody", self.go2_targetbodyCBK)
