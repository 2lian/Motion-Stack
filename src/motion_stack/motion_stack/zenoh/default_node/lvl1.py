...
from motion_stack.core.utils.joint_state import JState, MultiJState
...
class DefaultLvl1(Lvl1Node):
    ...
    def subscribe_to_lvl0(self, lvl0_input: Callable[[MultiJState], Any]):
        ...
        self.task_list.append(asyncio.create_task(sensor_loop()))
    ...
    def subscribe_to_lvl2(self, lvl2_input: Callable[[MultiJState], Any]):
        ...
        self.task_list.append(asyncio.create_task(command_loop()))
    ...
    def publish_to_lvl2(self, states: Dict[str, JState]):
        if len(states) <= 0:
            return
        for joint_name, js in states.items():
            self.lvl2_pub.pub(js, subkey=joint_name)
    ...
    def frequently_send_to_lvl2(self, send_function: Callable[[], None], period: float):
        ...
        self.task_list.append(asyncio.create_task(periodic()))
