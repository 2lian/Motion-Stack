...
ros2 launch ros2_m_hero_pkg hero_dragon.launch.py MS_up_to_level:=3 MS_simu_mode:=$USE_SIMU
# ros2 launch ros2_m_hero_pkg hero_all.launch.py MS_up_to_level:=5 MS_simu_mode:=$USE_SIMU
