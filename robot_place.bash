...
ros2 topic pub /r1/robot_body geometry_msgs/msg/Transform "{translation: {x: 0.2, y: 0.4, z: 0.0}, rotation: {x: 0.0, y: -0.2, z: 0.0, w: 0.8}}" --once
...
ros2 topic pub /r4/robot_body geometry_msgs/msg/Transform "{translation: {x: 0.4, y: 0.2, z: 0.5}, rotation: {x: 0.0, y: -0.4, z: 0.5, w: 0.2}}" --once
ros2 topic pub /r4/set_ik_target_0 geometry_msgs/msg/Vector3 "{x: 400, y: -200, z: 0.0}" --once &
ros2 topic pub /r4/set_ik_target_1 geometry_msgs/msg/Vector3 "{x: 100, y: 300, z: -150.0}" --once &
ros2 topic pub /r4/set_ik_target_2 geometry_msgs/msg/Vector3 "{x: -400, y: -100, z: -150.0}" --once &

ros2 topic pub /r5/robot_body geometry_msgs/msg/Transform "{translation: {x: 0.4, y: -0.5, z: 0.8}, rotation: {x: 0.0, y: 0.0, z: 0.0, w: 1.0}}" --once
# ros2 topic pub /r5/set_ik_target_0 geometry_msgs/msg/Vector3 "{x: 400, y: -200, z: 0.0}" --once &
# ros2 topic pub /r5/set_ik_target_1 geometry_msgs/msg/Vector3 "{x: 100, y: 300, z: -150.0}" --once &
# ros2 topic pub /r5/set_ik_target_2 geometry_msgs/msg/Vector3 "{x: -400, y: -100, z: -150.0}" --once &
